...
export const SUBSCRIPTIONS_GET_LIST_RESPONSE =
  'SUBSCRIPTIONS/GET_LIST_RESPONSE';
export const SUBSCRIPTIONS_GET_LIST_FAILURE = 'SUBSCRIPTIONS/GET_LIST_FAILURE';
export const SUBSCRIPTIONS_GET_LIST_BY_USER_REQUEST =
  'SUBSCRIPTIONS/GET_LIST_BY_USER_REQUEST';
export const SUBSCRIPTIONS_GET_LIST_BY_USER_RESPONSE =
  'SUBSCRIPTIONS/GET_LIST_BY_USER_RESPONSE';
export const SUBSCRIPTIONS_GET_LIST_BY_USER_FAILURE =
  'SUBSCRIPTIONS/GET_LIST_BY_USER_FAILURE';
