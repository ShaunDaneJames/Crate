        ...
        <div style={{ padding: '1em 1.2em' }}>
          ...
          >
            {/* 
              ...
              Update the <Button> onClick to to check to see if the user data in the store has
              style data associated with it. If it does, route to onClickSubscribe() as
              usual. If not, user should route to Style Survey Component. 
              */}
            <Button
              theme="primary"
